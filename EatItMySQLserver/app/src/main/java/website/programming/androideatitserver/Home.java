...
public class Home extends AppCompatActivity
   ...
   @Override
        ...
        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                try {
                    ...
                    String result = DBinsert.execute(method,newCategory.getCategoryid(),newCategory.getName(),newCategory.getImage()).get();
                    loadMenu();
                    //finish();
    ...
    private void createId() {
        ...
        for(Category category:jsondata)
        {
    ...
    private void upLoadImage() {
        if(saveUri != null)
        {
            ...
            try {
                ...
                createId();
                newCategory = new Category(String.valueOf(intCategoryId),edtName.getText().toString(), IMAGE_URL);
    ...
    private void loadMenu() {
       ...
       // if (databaseSelectServices == null) {
            ...
            if(parse_json.matches(BufferNoData)){
                adapter_new = new MenuAdapter_new(Emptyjsondata,this);
                adapter_new.notifyDataSetChanged();
                ...
                if (jsondata.size() > 0) {
                    adapter_new = new MenuAdapter_new(jsondata,this);
                    adapter_new.notifyDataSetChanged();
                    recyler_menu.invalidate();
                    recyler_menu.setAdapter(adapter_new);

                    Log.i("Load Menu", "Entered");
                    //recyler_menu.setAdapter(new MenuAdapter_new(jsondata,this));
                    //recyler_menu.invalidate();
                } else {
